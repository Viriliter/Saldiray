...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2IHi().pack(_x.timestamp.secs, _x.timestamp.nsecs, _x.stdId, _x.extId))
      _x = self.data
      length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.timestamp.secs, _x.timestamp.nsecs, _x.stdId, _x.extId,) = _get_struct_2IHi().unpack(str[start:end])
      start = end
      end += 4
...
def _get_struct_I():
    ...
    return _struct_I
_struct_2IHi = None
def _get_struct_2IHi():
    global _struct_2IHi
    if _struct_2IHi is None:
