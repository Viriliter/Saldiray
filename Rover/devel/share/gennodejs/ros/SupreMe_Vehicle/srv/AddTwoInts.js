...
// (in-package SupreMe_Vehicle.srv)
...
class AddTwoIntsRequest {
  ...
  static datatype() {
    ...
    return 'SupreMe_Vehicle/AddTwoIntsRequest';
  }
...
module.exports = {
  ...
  md5sum() { return '7727609bad06c3920b54439f5d0595ec'; },
  datatype() { return 'SupreMe_Vehicle/AddTwoInts'; }
};
