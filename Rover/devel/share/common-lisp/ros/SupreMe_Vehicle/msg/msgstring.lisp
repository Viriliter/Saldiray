...
(cl:defmethod cl:initialize-instance :after ((m <msgstring>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'msgstring)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name SupreMe_Vehicle-msg:<msgstring> is deprecated: use SupreMe_Vehicle-msg:msgstring instead.")))

(cl:ensure-generic-function 'msgtext-val :lambda-list '(m))
(cl:defmethod msgtext-val ((m <msgstring>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader SupreMe_Vehicle-msg:msgtext-val is deprecated.  Use SupreMe_Vehicle-msg:msgtext instead.")
  (msgtext m))
