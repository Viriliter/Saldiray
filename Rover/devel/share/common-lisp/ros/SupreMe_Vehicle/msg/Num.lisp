...
(cl:defmethod cl:initialize-instance :after ((m <Num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name SupreMe_Vehicle-msg:<Num> is deprecated: use SupreMe_Vehicle-msg:Num instead.")))

(cl:ensure-generic-function 'num-val :lambda-list '(m))
(cl:defmethod num-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader SupreMe_Vehicle-msg:num-val is deprecated.  Use SupreMe_Vehicle-msg:num instead.")
  (num m))
