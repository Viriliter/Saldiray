...
(cl:defmethod cl:initialize-instance :after ((m <reset_odometry-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'reset_odometry-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name supreme-srv:<reset_odometry-request> is deprecated: use supreme-srv:reset_odometry-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <reset_odometry-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'reset_odometry-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name supreme-srv:<reset_odometry-response> is deprecated: use supreme-srv:reset_odometry-response instead.")))

(cl:ensure-generic-function 'reset_done-val :lambda-list '(m))
(cl:defmethod reset_done-val ((m <reset_odometry-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader supreme-srv:reset_done-val is deprecated.  Use supreme-srv:reset_done instead.")
  (reset_done m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<reset_odometry-response>)))
  ...
  "supreme/reset_odometryResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'reset_odometry-response)))
  "Returns string type for a service object of type 'reset_odometry-response"
  "supreme/reset_odometryResponse")
