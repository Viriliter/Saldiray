...
(cl:defmethod cl:initialize-instance :after ((m <TrialService-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TrialService-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name supreme-srv:<TrialService-request> is deprecated: use supreme-srv:TrialService-request instead.")))

(cl:ensure-generic-function 'user-val :lambda-list '(m))
(cl:defmethod user-val ((m <TrialService-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader supreme-srv:user-val is deprecated.  Use supreme-srv:user instead.")
  (user m))

(cl:ensure-generic-function 'state-val :lambda-list '(m))
(cl:defmethod state-val ((m <TrialService-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader supreme-srv:state-val is deprecated.  Use supreme-srv:state instead.")
  (state m))
...
(cl:defmethod cl:initialize-instance :after ((m <TrialService-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TrialService-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name supreme-srv:<TrialService-response> is deprecated: use supreme-srv:TrialService-response instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <TrialService-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader supreme-srv:name-val is deprecated.  Use supreme-srv:name instead.")
  (name m))
